...
###
# This class looks for ¨texfactory like packages that will be analyzed later.
###
...
###
# This method manages the search of the ¨texfactory like packages.
###
...
###
# This methods builds the sorted list of the ``PPath`` of the ¨texfactory  
# packages to analyze.
###
...
#                the **unsorted** list of the ``PPath`` of the ¨texfactory 
...
#
#     :return: = ; // See Python typing...
#                ``True`` if the ``about.peuf`` indicates a ¨texfactory package,
...
# Good formatting about file.
        if GENE_TAG in infos:
            ...
            return infos.get(GENE_MONOREPO_TAG, "") == TEX_MONOREPO_TAG
