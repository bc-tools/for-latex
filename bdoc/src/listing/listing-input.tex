...
Le contenu de ce fichier est l'unique ligne \docinlatex|$x y z = 1$| .
...
Ainsi \docinlatex|\inputdoclatexbefore[Voici ce que cela donne.]{...}| aboutit au résultat suivant.
...
Via \docinlatex|\inputdoclatexafter[Cette formule se tape comme suit.]{...}| , on obtient le résultat ci-après.
...
Là aussi le texte par défaut peut être \docquote{personnalisé}. Par exemple, ce qui suit a été obtenu via \docinlatex|\inputdoclatexreal[On obtient le rendu réel ci-après.]{...}| .
