...
La macro \bdocmacro{docinEN} et sa version étoilée s'appuient sur \bdocmacro{docquote} : par exemple, le code \bdocinlatex|\bdocquote{sémantique}| produit \bdocquote{sémantique}.
