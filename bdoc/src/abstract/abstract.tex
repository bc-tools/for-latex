...
Son but est de faciliter la saisie sémantique de documentations de packages \LaTeX\ avec un rendu sobre pour une lecture sur écran
\footnote{
...
\begin{bdocnote}
	...
	Dans un avenir plus ou moins proche,  \bdocpack{bdoc} devrait être éclaté en une classe et un package.
\end{bdocnote}
