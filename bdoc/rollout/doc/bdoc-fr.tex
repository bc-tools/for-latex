...
\title{Le package \texttt{bdoc} - Documenter simplemnt}
...
Pour les codes suivants, on considère un fichier \verb+xyz.tex+ avec le contenu suivant, et ayant relativement au présent document le chemin \verb+examples/listing/xyz.tex+ .
...
\begin{bdocexa}[Changer le texte explicatif]
    Pour obtenir ce qui suit avec un texte personnalisé, il suffit d'employer \bdocinlatex|\bdoclatexshow[explain = Voici le rendu réel.]{examples/listing/xyz.tex}|.
