...
\date{25 oct. 2024 - Version 1.6.0}
...
\begin{tdocupdate}
    \item Journal des modifications : pour l'environnement \tdocenv*{tdocupdate}, la icône \fbox{\reflectbox{\faHistory}} remplace l'ancienne icône \fbox{\faMagic}\,.
\end{tdocupdate}
\end{tdocnote}
\end{minipage}
\end{center}
