...
\task scrartcl.cls (2024/10/24)
\end{tasks}
%
\begin{tasks}[style=itemize](2)
\task clrstrip.sty (2021/08/28)
\task csquotes.sty (2024/04/04)
\task fontawesome5.sty (2022/05/02)
\task geometry.sty (2020/01/02)
\task hyperref.sty (2024/11/05)
\task inputenc.sty (2024/02/08)
\task keytheorems.sty (2024/11/11)
\task marginnote.sty (2018/08/09)
\task minted.sty (2024/11/17)
\task tcolorbox.sty (2024/10/22)
\end{tasks}
