...
\begin{tdocwarn}
	For the moment, the macros for dating and versioning presented in the \ref{tutodoc-changes} section are not adaptive, i.e. changing \tdocinlatex{fontsize = 10pt} and \tdocinlatex{DIV = 12} will break the rendering of these macros.
\end{tdocwarn}
