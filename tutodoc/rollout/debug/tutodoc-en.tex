...
\begin{tdocbreak}
	...
	\item The \tdocmacro{tdocruler} macro is now used via \tdocinlatex{tdocruler[<color>]{<text>}} (previously you had to use \tdocinlatex{tdocruler{<text>}{<color>}}).
\end{tdocbreak}
...
\begin{tdocbreak}
	...
	\item The \tdocmacro{tdocruler} macro is now used via \tdocinlatex{tdocruler[<color>]{<text>}} (remember that the old syntax was \tdocinlatex{tdocruler{<text>}{<color>}}).
\end{tdocbreak}
