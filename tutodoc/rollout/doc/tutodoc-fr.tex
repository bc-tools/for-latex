...
\NewDocumentEnvironment{ tdocshowcase }
...
\subsection{Du contenu tape-à-l'oeil} \label{tutodoc-admonitions}
...
\section{Un rendu en situation réelle} \label{tutodoc-showcase}
...
\subsection{Avec une bande colorée} \label{tutodoc-color-macros}
...
\subsection{Codes \tdocquote{en ligne}} \label{tutodoc-listing-inline}
...
\subsection{Codes importés et mis en situation} \label{tutodoc-latexshow}
