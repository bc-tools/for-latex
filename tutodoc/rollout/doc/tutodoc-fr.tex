...
\tdoclatexinput[\tdocstyle{sbs}]{examples-admonitions-exa.tex}
...
\tdoclatexinput[\tdocstyle{sbs}]{examples-admonitions-exa-leavevmode.tex}
...
\tdoclatexinput[\tdocstyle{sbs}]{examples-admonitions-rmk.tex}
...
\tdoclatexinput[\tdocstyle{sbs},bottom=3pt,top=3pt]{examples-admonitions-tip.tex}
...
\begin{tdoctip}
    ...
    \tdoclatexinput[\tdocstyle{sbs},bottom=3pt,top=3pt]{examples-admonitions-leavevmode-items.tex}
...
\foreach \sectitle/\desc/\filename in {
    ...
    \tdoclatexinput[\tdocstyle{sbs},bottom=3pt,top=3pt]{examples-admonitions-\filename.tex}
...
\begin{tdocexa}[Avec les textes par défaut]
    ...
    \tdoclatexinput[\tdocstyle{code}]{examples-showcase-default.tex}
...
\begin{tdocexa}[Changer les couleurs et/ou les textes par défaut]
    ...
    \tdoclatexinput[\tdocstyle{code}]{examples-showcase-customized.tex}
...
\begin{tdocwarn}
    ...
    \tdoclatexinput[\tdocstyle{code}]{examples-showcase-hook.tex}
...
\begin{tdocexa}
    ...
    \tdoclatexinput[\tdocstyle{code}]{examples-showcase-nostripe.tex}
...
\begin{tdocexa}[Changer les couleurs et/ou les textes par défaut]
    ...
    \tdoclatexinput[\tdocstyle{code}]{examples-showcase-nostripe-customized.tex}
...
\begin{tdocexa}[Face à face]
    Afficher un code et son rendu côte à côte se fait comme suit où \tdoclatexin#sbs# est pour \tdocquote{\tdocprewhy{s.ide} \tdocprewhy{b.y} \tdocprewhy{s.ide}} soit \tdocinEN{côte à côte}, et la macro \tdocmacro{tdocstyle} permet de taper \tdoclatexin{\tdocstyle{sbs}} au lieu de \tdoclatexin{listing side text}.
...
\begin{tdocexa}[À la suite]
    \tdocenv{tdoclatex} produit le résultat suivant où l'option par défaut correspondant à \tdoclatexin#\tdocstyle{std}#\,.
    \footnote{
...
\begin{tdocexa}[Juste le code]
    Via l'option \tdoclatexin#\tdocstyle{code}#, on aura juste le code comme ci-après.
...
\tdoclatexinput[\tdocstyle{code}]{examples-listing-latex-xyz.tex}
...
\begin{tdocexa}[Face à face]
    ...
    \begin{tdoclatex}[\tdocstyle{code}]
\tdoclatexinput[\tdocstyle{sbs}]{examples-listing-latex-xyz.tex}
...
\tdoclatexinput{examples-listing-latex-xyz.tex}
    ...
    Ceci produit la mise en forme suivante où l'option par défaut est \tdoclatexin#\tdocstyle{std}#\,.
...
\begin{tdocexa}[Les options disponibles]
    ...
    \tdoclatexinput[\tdocstyle{code}]{examples-listing-latex-latexshow-options.tex}
...
\foreach \exatitle/\filename in {
    ...
    \begin{tdocexa}[\exatitle]
        ...
        \tdoclatexinput[\tdocstyle{sbs}]{examples-version-n-change-chges-\filename.tex}
...
\foreach \exatitle/\filename in {
    ...
    \begin{tdocexa}[\exatitle]
        ...
        \tdoclatexinput[\tdocstyle{sbs}]{examples-version-n-change-color-chges-\filename.tex}
