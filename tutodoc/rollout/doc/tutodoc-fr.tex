...
\begin{tdocexa}
    ...
    Quant à \tdocinlatex+\tdocshowcaseinput[col-stripe = red, col-text = orange!75!black]{external.tex}+\,, ceci produira le changement de couleur observable ci-après.
...
\begin{tdocwarn}
    ...
    \tdoclatexshow[nostripe, col-stripe=red]{examples-version-n-change-side-effect.tex}
