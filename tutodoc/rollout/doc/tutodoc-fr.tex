...
\begin{filecontents*}[overwrite]{examples-listing-full-hello-world.b}
...
\begin{filecontents*}[overwrite]{examples-listing-full-hello-you.lua}
...
\begin{filecontents*}[overwrite]{examples-listing-full-hello-you.pl}
print "Qui êtes-vous ? ";
my $name = <STDIN>;
...
\begin{filecontents*}[overwrite]{examples-listing-full-hello-you.py}
...
\begin{filecontents*}[overwrite]{examples-listing-full-hello-you.java}
...
\tdoccodein{py}{print("Hello!")}


\tdoccodeinput{py}{examples-listing-full-hello-you.py}
