...
\begin{tdocexa}[Face à face]
    Via \tdocenv[{[\tdocstyle{sbs}]}]{tdoclatex}, on affichera un code et son rendu côte à côte.
...
\begin{tdocexa}[Juste le code]
    Via \tdocenv[{[\tdocstyle{code}]}]{tdoclatex}, on aura juste le code comme ci-après.
