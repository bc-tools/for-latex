...
\tdoclatexinput[code]{examples-listing-latex-xyz.tex}
...
\begin{tdocexa}[Face à face]
    ...
    \begin{tdoclatex}[code]
\tdoclatexinput[sbs]{examples-listing-latex-xyz.tex}
...
\begin{tdocexa}[Les options disponibles]
    ...
    \tdoclatexinput[code]{examples-listing-latex-latexshow-options.tex}
...
Pour ce type de projet, il est utile de pouvoir présenter des lignes de code \lua. Or, \tdocpack{minted} est chargé en coulisse par \thisproj, donc il est facile de proposer des macros et des environnements pour la mise en forme de codes dans tous les langages supportés par \href{https://pygments.org/}{Pygments}.%
\footnote{
	\tdocpack{minted} s'appuie le projet \python\ \trademark{Pygments} pour la coloration des codes informatiques.
}
