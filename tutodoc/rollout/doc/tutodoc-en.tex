...
\begin{tdocexa}[Following]
    \tdocenv{tdoclatex} produces the following result via the default option corresponding to \tdoclatexin#\tdocstyle{std}#\,.
    \footnote{
...
\tdoclatexinput{examples-listing-latex-xyz.tex}
    ...
    This produces the following formatting where the default option is \tdoclatexin#\tdocstyle{std}#.
