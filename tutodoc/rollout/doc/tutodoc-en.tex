...
\begin{tdocexa}[Side by side]
     Displaying code and rendering side by side is done as follows where \tdoclatexin#sbs# is for \tdocquote{\tdocprewhy{s.ide} \tdocprewhy{b.y} \tdocprewhy{s.ide}}, and the macro \tdocmacro{tdoctcb} allows you to type \tdoclatexin{tdocstyle{sbs}} instead of \tdoclatexin{listing side text}.
