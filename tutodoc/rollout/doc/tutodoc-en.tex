...
\begin{tdocnote}
	The page \url{https://pygments.org/languages/} contains a complete list of supported languages with their short names.
	For example, it is possible to format \brainfuck\ code like this sequence \tdoccodein{bf}{++++++++++[>+++++++>++++++++++>+++>+<<<<-]>++.>+.+++++++..+++.} which displays \tdoccodein{text}{Hello}\,.
\end{tdocnote}
