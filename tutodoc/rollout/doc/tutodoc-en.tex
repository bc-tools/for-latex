...
\tdoclatexinput[\tdocstyle{sbs}]{examples-admonitions-tip.tex}
...
\begin{tdoctip}
    ...
    \tdoclatexinput[\tdocstyle{sbs}]{examples-admonitions-leavevmode-items.tex}
...
\foreach \sectitle/\desc/\filename in {
    ...
    \tdoclatexinput[\tdocstyle{sbs}]{examples-admonitions-\filename.tex}
...
\begin{tdocexa}[Side by side]
    Using \tdocenv[{[\tdocstyle{sbs}]}]{tdoclatex}, we can display a code and its rendering side by side.
...
\begin{tdocexa}[Just the code]
    Via \tdocenv[{[\tdocstyle{code}]}]{tdoclatex}, we'll just get the code as shown below.
