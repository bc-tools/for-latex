...
\subsection{Flashy content} \label{tutodoc-admonitions}
...
\section{A real-life rendering} \label{tutodoc-showcase}
...
\subsection{With a colored stripe} \label{tutodoc-color-macros}
...
\subsection{\tdocquote{Inline} codes} \label{tutodoc-listing-inline}
...
\subsection{Imported codes put into practice} \label{tutodoc-latexshow}
