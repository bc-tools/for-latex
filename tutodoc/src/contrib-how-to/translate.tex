...
\subsubsection{Les fichiers \texttt{README.md} et \texttt{LICENCE.txt}}

Le fichier \texttt{LICENCE.txt} est bien nommé, tandis que le fichier \texttt{README.md} reprend en anglais les points importants de ce qui est dit dans cette section à propos des nouvelles traductions.
...
\begin{tdocimp}
    ...
    Les contenus de ces fichiers utilisent des lignes commentées en anglais pour expliquer ce que fera \thisproj\ ; ces lignes commencent par \verb#//#\,. Voici un extrait de ce type de fichier où \textbf{les traductions se font après chaque signe \,\fbox{$=$\vphantom{pM}}\ sans toucher à ce qui se trouve avant}, car ce morceau initial est utilisé en interne par le code de \thisproj..
...
Voici ce qu'il faut faire via \git.
%
\begin{enumerate}
