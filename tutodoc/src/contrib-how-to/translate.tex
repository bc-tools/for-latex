...
\begin{enumerate}
	...
	\item Il ne reste plus qu'à copier intégralement le contenu de \verb#translate/en# dans un dossier \verb#italian# pour faire les traductions en italien.%
	\footnote{
...
\begin{tdocimp}
  ...
  Dans ces fichiers, les traductions se font après chaque signe $=$\,, ce qui se trouve avant est utilisé en interne par le code de \thisproj.
\end{tdocimp}
