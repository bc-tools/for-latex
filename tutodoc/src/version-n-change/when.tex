...
\begin{tdocexa}[Versionner et dater des nouveautés]
...
%    \footnote{
%        L'auteur de \tdocpack{tdoc} est entrain de mettre en place un ensemble d'outils permettant une telle semi-automatisation.
%    }.
\end{tdocwarn}
