...
\immediate\write18{pdflatex -shell-escape gallery-showcase-bw}

\immediate\write18{pdflatex -shell-escape gallery-showcase-color}

\immediate\write18{pdflatex -shell-escape gallery-showcase-dark}

\immediate\write18{pdflatex -shell-escape gallery-showcase-draft}
