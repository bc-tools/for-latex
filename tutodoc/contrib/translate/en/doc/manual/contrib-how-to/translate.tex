...
\begin{tdocimp}
    ...
    The content of these files uses commented lines in English to explain what \thisproj\ will do; these lines begin with \verb#//#\,. Here's an extract from such a file, where translations are made after each \,\fbox{$=$\vphantom{pM}}\ sign, without touching the preceding, as this initial piece is used internally by the \thisproj\ code.
