...
\begin{tdocexa}[Standard usage]
    The macro \tdocmacro{tdoclatexin}
    \footnote{
        The name of the macro \tdocmacro{tdoclatexin} comes from \tdocquote{tdocprewhy{in.line} \LaTeX} or \tdocinEN{LaTeX\ online}.
    }
    ...
    \footnote{
    	A background colour is deliberately used to subtly highlight the codes \tdoclatexin{LaTeX}\,.
    }

    \begin{tdoclatex}<tdoctcb{sbs}>
1: \tdoclatexin|$a^b = c$| \\\\
